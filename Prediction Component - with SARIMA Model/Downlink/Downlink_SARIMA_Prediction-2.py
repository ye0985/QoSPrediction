...
#Fit SARIMA Model
SARIMA1 = sm.tsa.statespace.SARIMAX(data, order=(1,1,0), seasonal_order=(1,1,2,12) ,enforce_stationarity=False,enforce_invertibility=False)
...
plt.plot(data.downlink, label = 'Original')
